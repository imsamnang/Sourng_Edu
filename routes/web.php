...
// Permission Routes
    ...
    Route::get('permission/{id}/edit',          ['as' => 'permission.edit',             'middleware' => ['ability:super-admin,role-edit'],          'uses' => 'PermissionController@edit']);
    Route::post('permission/{id}/update',       ['as' => 'permission.update',           'middleware' => ['ability:super-admin,role-edit'],          'uses' => 'PermissionController@update']);
    Route::get('permission/{id}/delete',        ['as' => 'permission.delete',           'middleware' => ['ability:super-admin,role-delete'],        'uses' => 'PermissionController@destroy']);
...
// Manage Projects
  // get district and commune
    ...
    Route::prefix('projects')->group(function(){
      ...
      Route::post('/staff-register','ProjectActivities\StaffActivitiesController@staffSave')->name('staff-register.store');
      Route::get('/read-book/login','ProjectActivities\GuestLoginController@index')->name('read-book');
      Route::get('/add-newbook','ProjectActivities\AddnewbookController@index')->name('add-newbook');
