...
class ZimageController extends Controller
{   
    protected $tmp_path = 'z-tmp';
    protected $upload_path = 'z-upload';
    ...
    {          
        ...
        $data['upload_url']  = \URL::to('/image/upload');
        $data['save_url']    = \URL::to('/image/save');
        $data['rotate_url']  = \URL::to('/image/rotate').'/';
        $data['delete_url']  = \URL::to('/image/delete').'/';
        $data['allow_size']  = $this->allow_size;
        return view('z-image', $data);       
    }
    /**
