...
--
-- Host: localhost:3306
-- Generation Time: Oct 18, 2019 at 07:20 PM
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Member of Professional Association';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Long Program';
...
CREATE TABLE `course_long_student` (
  `id` int(11) NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Short Course';
...
CREATE TABLE `course_short_student` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `course_short_teacher` (
  `id` int(11) NOT NULL,
  `course_short_id` int(11) NOT NULL,
...
CREATE TABLE `curriculum_author` (
  `id` int(11) NOT NULL,
  `title_kh` varchar(250) DEFAULT NULL,
  `title_en` varchar(250) DEFAULT NULL,
  `create_by` int(11) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Curriculum Author';
...
CREATE TABLE `curriculum_endorsement` (
  `id` int(11) NOT NULL,
  `title_kh` varchar(250) DEFAULT NULL,
  `title_en` varchar(250) DEFAULT NULL,
  `create_by` int(11) DEFAULT NULL,
  `create_date` date DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Curriculum Endorsement';
...
CREATE TABLE `days` (
  ...
  `title_kh` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `days` (`id`, `created_at`, `updated_at`, `created_by`, `last_updated_by`, `title`, `title_kh`, `status`) VALUES
(1, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Sunday', 'អាទិត្យ', 1),
(2, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Monday', 'ច័ន្ទ', 1),
(3, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Tuesday', 'អង្គារ', 1),
(4, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Wednesday', 'ពុធ', 1),
(5, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Thursday', 'ព្រហស្បត្តិ៍', 1),
(6, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Friday', 'សុក្រ', 1),
(7, '2019-01-23 15:38:07', '2019-01-23 15:38:07', 1, NULL, 'Saturday', 'សៅ', 1);
...
(8, 0, 'staff', 13, '2019-10-10 02:16:05', 'Adolescent Nutrition Facilitation Manual', '7006_adolescent-nutrition-facilitation-manual.pdf', NULL, '2019-10-10 02:16:05', 25, NULL, 1),
(10, 0, 'staff', 13, '2019-10-10 02:20:20', 'Adolescent Sexual Reproductive Health Facilitation Manual', '5097_adolescent-sexual-reproductive-health-facilitation-manual.pdf', NULL, '2019-10-10 02:20:20', 25, NULL, 1),
(11, 0, 'staff', 15, '2019-10-10 02:36:58', 'ចូរសរសេរកូដដើម្បីរកតម្លៃធំបំផុតនៃពីចំនួន', '5420_.pdf', 'ចូរសរសេរកូដដើម្បីរកតម្លៃធំបំផុតនៃពីចំនួន', '2019-10-10 02:36:58', 1, NULL, 1);
...
CREATE TABLE `exam_pretest_schedules` (
  `id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Marital Status';
...
CREATE TABLE `overal_fund` (
  `id` int(11) NOT NULL,
  `title_kh` varchar(250) DEFAULT NULL,
  `title_en` varchar(250) DEFAULT NULL,
  `create_by` int(11) DEFAULT NULL,
  `create_date` date DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Overall Fund';
...
CREATE TABLE `project_report_analysis` (
  `id` int(11) NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Qualifications';
...
CREATE TABLE `question_subject_quiz` (
  `id` int(10) UNSIGNED NOT NULL,
  `question_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `shortcourse_teacher` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `student_long_course` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `course_long_id` int(11) NOT NULL,
  `quarter` int(11) DEFAULT NULL
...
CREATE TABLE `subject_course_outline` (
  `id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
...
CREATE TABLE `subject_main_program` (
  `id` int(11) NOT NULL,
  `code` varchar(250) DEFAULT NULL,
  `title_kh` varchar(250) DEFAULT NULL,
  `title_en` varchar(250) DEFAULT NULL,
...
CREATE TABLE `teacher_exam` (
  ...
  `title_kh` varchar(250) DEFAULT NULL,
  `title_en` varchar(250) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Teacher Exam';
...
(1, '2019-10-18 05:14:56', '2019-10-18 05:14:56', 1, NULL, 2, 1, 0, 1, 'Registration', 1);
...
CREATE TABLE `transport_tethod` (
  `id` int(11) NOT NULL,
  `transport_kh` varchar(250) DEFAULT NULL,
  `transport_en` varchar(250) DEFAULT NULL,
  `note` text DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='TransportMethod';
...
(1, '2019-10-18 05:14:56', '2019-10-18 05:14:56', 1, NULL, 1, 0, 2, 1, 1);
...
(1, 'Seng Sourng', 'sengsourng@gmail.com', '', '$2y$10$hrczYzGqyGc/Yham6rekXeZFAiumNtAMaOzNCrIRCLVKPhqJZUL4S', 'WiXC6lLuhFJsA4nH4wo0A8acb6OBnVhhjoT2ev4knLslwliJGeICNpDqs0ry', '2019-10-18 04:52:35', '42.115.2.136', NULL, '2019-10-18 04:52:35', '092771244', 'Siem Reap', '4850.jpg', NULL, NULL, 1, 1);
...
(1, '2019-03-15 01:57:57', '2019-10-18 05:13:59', 1, 1, 'សរ០០៩៩', 'កាមារី', 'កាមារីសេរី២០១៥', 'ឡានមាកកាមារីឆ្នាំ២០១៥', 1);
...
ALTER TABLE `average_scores`
  ...
  ADD KEY `average_scores_subject_id_foreign` (`subject_id`),
...
--
-- Indexes for table `course_long`
--
ALTER TABLE `course_long`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `course_long_student`
--
ALTER TABLE `course_long_student`
  ADD PRIMARY KEY (`id`,`course_long_id`,`overal_fund_id`,`student_id`,`institute_id`);

--
-- Indexes for table `course_short`
--
ALTER TABLE `course_short`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `course_short_student`
--
ALTER TABLE `course_short_student`
  ADD PRIMARY KEY (`id`,`course_short_id`,`overal_fund_id`,`student_id`,`institute_id`);

--
-- Indexes for table `course_short_teacher`
--
ALTER TABLE `course_short_teacher`
  ADD PRIMARY KEY (`id`,`course_short_id`,`staff_id`);
...
--
-- Indexes for table `curriculum_author`
--
ALTER TABLE `curriculum_author`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `curriculum_endorsement`
--
ALTER TABLE `curriculum_endorsement`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `exam_pretest_schedules`
--
ALTER TABLE `exam_pretest_schedules`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `overal_fund`
--
ALTER TABLE `overal_fund`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `project_report_analysis`
--
ALTER TABLE `project_report_analysis`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `question_subject_quiz`
--
ALTER TABLE `question_subject_quiz`
  ADD PRIMARY KEY (`id`),
  ADD KEY `question_subject_quiz_subject_quiz_id_foreign` (`subject_quiz_id`),
  ADD KEY `question_subject_quiz_question_id_foreign` (`question_id`);
...
ALTER TABLE `quiz_results`
  ADD PRIMARY KEY (`id`),
  ADD KEY `quiz_results_subject_id_foreign` (`subject_id`),
  ADD KEY `quiz_results_user_id_foreign` (`user_id`,`test_type_id`);
...
--
-- Indexes for table `shortcourse_teacher`
--
ALTER TABLE `shortcourse_teacher`
  ADD PRIMARY KEY (`id`,`teacher_id`,`shortcourse_id`);
...
--
-- Indexes for table `student_long_course`
--
ALTER TABLE `student_long_course`
  ADD PRIMARY KEY (`id`,`student_id`,`course_long_id`);
...
--
-- Indexes for table `subject_course_outline`
--
ALTER TABLE `subject_course_outline`
  ADD PRIMARY KEY (`id`,`subject_id`);

--
-- Indexes for table `subject_main_program`
--
ALTER TABLE `subject_main_program`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indexes for table `subject_quizzes`
--
ALTER TABLE `subject_quizzes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `transport_tethod`
--
ALTER TABLE `transport_tethod`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `user_answers`
  ...
  ADD KEY `user_answers_subject_id_foreign` (`subject_id`),
  ADD KEY `user_answers_question_id_foreign` (`question_id`),
  ADD KEY `user_answers_userdata_appear_id_foreign` (`userData_appear_id`);
...
--
ALTER TABLE `average_scores`
  MODIFY `avgid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT for table `course_long`
--
ALTER TABLE `course_long`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `course_long_student`
--
ALTER TABLE `course_long_student`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `course_short`
--
ALTER TABLE `course_short`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `course_short_student`
--
ALTER TABLE `course_short_student`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `course_short_teacher`
--
ALTER TABLE `course_short_teacher`
...
--
-- AUTO_INCREMENT for table `curriculum_author`
--
ALTER TABLE `curriculum_author`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `curriculum_endorsement`
--
ALTER TABLE `curriculum_endorsement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `exam_pretest_schedules`
--
ALTER TABLE `exam_pretest_schedules`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `overal_fund`
--
ALTER TABLE `overal_fund`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `project_report_analysis`
--
ALTER TABLE `project_report_analysis`
...
--
-- AUTO_INCREMENT for table `question_subject_quiz`
--
ALTER TABLE `question_subject_quiz`
...
--
-- AUTO_INCREMENT for table `subject_course_outline`
--
ALTER TABLE `subject_course_outline`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `subject_quizzes`
--
ALTER TABLE `subject_quizzes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `transport_tethod`
--
ALTER TABLE `transport_tethod`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
