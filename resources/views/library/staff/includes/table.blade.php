<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; {{__('member_tbl_staff_List')}}</h4>
        <div class="clearfix">
        ...
        <div>
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th>@lang('member_tbl_staff_S_N')</th>
                    <th>@lang('member_tbl_staff_Reg_Num')</th>
                    <th>@lang('member_tbl_staff_Staff_Name')</th>
                    <th>@lang('member_tbl_staff_Phone')</th>
                    <th>@lang('member_tbl_staff_Status')</th>
                </tr>
                </thead>
                <tbody>
