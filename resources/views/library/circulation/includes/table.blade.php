<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{__('Library_Circulation_List')}}</h4>
        <div class="clearfix">
            <span class="pull-right tableTools-container"></span>
        </div>
        <div class="table-header">
            Library Circulation List Record list on table. Filter list using search box as your Wish.
        </div>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('circul_tbl_S_N')</th>
                            <th>@lang('circul_tbl_User_Type')</th>
                            <th>@lang('circul_tbl_Code_Prefix')</th>
                            <th>@lang('circul_tbl_Issue_Limit_Days')</th>
                            <th>@lang('circul_tbl_Issue_Limit_Book')</th>
                            <th>@lang('circul_tbl_Fine_Per_Day')</th>
                            <th>@lang('circul_tbl_Status')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td colspan="9">No {{ $panel }} data found.</td>
                                </td>
                            </tr>
                        @endif
                    </tbody>
