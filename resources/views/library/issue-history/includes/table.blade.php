<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{__('issue_tbl_history_History_List')}}</h4>
        <div class="clearfix">
            <span class="pull-right tableTools-container"></span>
        </div>
        <div class="table-header">
            History Record list on table. Filter list using search box as your Wish.
        </div>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover ">
                <thead>
                <tr>
                    <th>@lang('issue_tbl_history_S_N')</th>
                    <th>@lang('issue_tbl_history_Reg_No')</th>
                    <th>@lang('issue_tbl_history_Reference_No')</th>
                    <th>@lang('issue_tbl_history_Book')</th>
                    <th>@lang('issue_tbl_history_Category')</th>
                    <th>@lang('issue_tbl_history_Issued_On')</th>
                    <th>@lang('issue_tbl_history_Due_Date')</th>
                    <th>@lang('issue_tbl_history_Return_Date')</th>
                    <th>@lang('issue_tbl_history_Day')</th>
                </tr>
                </thead>
                <tbody>
                @if (isset($data['history']) && $data['history']->count() > 0)
                    ...
                    @foreach($data['history'] as $history)
                        <tr>
                            ...
                            <td>
                                <div class="label label-info label-lg ">
                                    {{  (\Carbon\Carbon::parse($history->return_date)
