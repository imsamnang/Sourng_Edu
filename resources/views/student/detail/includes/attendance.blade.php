<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{__('stu_frm_att_Attendence_Detail')}}</h4>
        <!-- div.table-responsive -->
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th>@lang('stu_frm_att_S_N')</th>
                    <th>@lang('stu_frm_att_Year')</th>
                    <th>@lang('stu_frm_att_Month')</th>
                    <th>1</th>
                    <th>2</th>
                    <th>3</th>
                    <th>4</th>
                ...
                @else
                    <tr>
                        <td colspan="34"  class="align-left">No attendance data found.</td>
                        </td>
                    </tr>
                @endif
                </tbody>
