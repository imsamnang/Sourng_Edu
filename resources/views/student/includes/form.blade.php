...
<div class="panel panel-default">
        <div class="panel-heading">
            <a href="#faq-1-1" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                ...
                <h4 data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed" class="header large lighter blue"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;@lang('m_Detail_Search_Student')</h4>
            </a>
        </div>
            ...
            <div class="panel-body">
                    <div class="clearfix">
                            <div class="form-group">
                                ...
                                {!! Form::label('reg_date', __('m_stu_detail_regdate'), ['class' => 'col-sm-1 control-label']) !!}
                                <div class=" col-sm-5">
                            ...
                            <label class="col-sm-1 control-label">@lang('m_stu_detail_semester')</label>
                            <div class="col-sm-2">
