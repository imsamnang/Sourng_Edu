            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <a class="{!! request()->is('student/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('student.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;{{__('stu_Bulk_Student_Registration')}}</a>
                        </div>
