                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            ...
                                            <a href="{{ route($base_route.'.edit', ['id' => $note->id]) }}" class="btn btn-primary btn-minier btn-success">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $note->id]) }}" class="btn btn-primary btn-minier btn-danger bootbox-confirm" >
