...
<div class="tabbable">
  <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
    <li class="active">
      <a data-toggle="tab" href="#registrationinfo">@lang('staff_frm_reg_General_Information')</a>
    </li>
    <li class="">
  ...
  <div class="tab-content">
    <div id="registrationinfo" class="tab-pane active">
      ...
      <div class="form-group">
        ...
        {!! Form::label('temp_country', __('staff_frm_reg_Country'), ['class' => 'col-sm-1 control-label']) !!}
        <div class="col-sm-3">
          ...
          {!! Form::label('temp_province', __('shortcoure_Province'), ['class' => 'col-sm-1 control-label']) !!}
        <div class="col-sm-3">
          <select style="width: 100%" name="temp_province" id="temp_province">
            @if($flag=='kh')
            {
              <option value="0">ជ្រើសខាងក្រោម៖ </option>
            }
          ...
          @include('includes.form_fields_validation_message', ['name' => 'temp_province'])
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-xs-12 col-sm-1 control-label">{{ __('shortcoure_District') }}</label>
        <div class="col-sm-3">
          <select style="width: 100%" name="temp_district" id="temp_district" required="" >
            @if($flag=='kh')
            {
            <option value="0">ជ្រើសខាងក្រោម៖ </option>
            }
          ...
          @include('includes.form_fields_validation_message', ['name' => 'temp_district'])
        </div>
        <label class="control-label col-xs-12 col-sm-1 control-label">{{ __('shortcoure_Commune') }}</label>
        <div class="col-sm-3">
          <select style="width: 100%" name="temp_commune" id="temp_commune" required="" >
            @if($flag=='kh')
            {
              <option value="0">ជ្រើសខាងក្រោម៖ </option>
            }
          ...
          @include('includes.form_fields_validation_message', ['name' => 'temp_commune'])
        </div>
        <label class="control-label col-xs-12 col-sm-1 control-label">{{ __('Village') }}</label>
        <div class="col-sm-3">
          {!! Form::text('temp_village', null, ["class" => "form-control border-form upper","required"]) !!}
          @include('includes.form_fields_validation_message', ['name' => 'temp_village'])
        </div>
      </div>
