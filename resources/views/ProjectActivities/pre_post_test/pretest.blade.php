...
<div class="container">
	<div id="quizmain">
		<div id="quizcontainer">      
			...
			<p id="qtext">Inside which HTML element do we put the JavaScript?</p>
			<form role="form" id="quizform" name="quizform" action="quiztest.asp?qtest=JavaScript" method="post">
			<input type="hidden" name="starttime" value="6/29/2019 5:55:15 AM">
			...
			<div style="position:relative;width:100%;">
				<div id="altcontainer">
					<label class="radiocontainer" id="label1"> &lt;scripting&gt;<input type="radio" name="quiz" id="1" onclick="clickRadio(this)" value="1"><span class="checkmark"></span></label><label class="radiocontainer" id="label2"> &lt;script&gt;<input type="radio" name="quiz" id="2" onclick="clickRadio(this)" value="2"><span class="checkmark"></span></label><label class="radiocontainer" id="label4"> &lt;js&gt;<input type="radio" name="quiz" id="4" onclick="clickRadio(this)" value="4"><span class="checkmark"></span></label><label class="radiocontainer" id="label3"> &lt;javascript&gt;<input type="radio" name="quiz" id="3" onclick="clickRadio(this)" value="3"><span class="checkmark"></span></label>
				</div>
			</div>
			<div id="answerbuttoncontainer">
					<button class="answerbutton w3-btn" type="submit" onclick="clickNextButton(1)">Next ❯</button>
