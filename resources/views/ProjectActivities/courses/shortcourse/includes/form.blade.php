<div class="tabbable">
        <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
            <li class="active">
                <a data-toggle="tab" href="#registrationinfo">Staff @lang('staff_frm_reg_General_Information')</a>
            </li>
            <li class="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            @if ($data['row']->staff_image)
                                <img id="avatar"  src="{{ asset('images/staff/'.$data['row']->staff_image) }}" class="img-responsive" width="100">
                            @else
