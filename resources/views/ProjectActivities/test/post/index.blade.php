    ...
    <div class="main-content">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <a href="{{ route('posttesttype') }}"><button type="button" class="width-35 pull-right btn btn-sm btn-primary">
                                                    <i class="ace-icon fa fa-key"></i>
                                                    <span class="bigger-110">Login</span>
                                                </button>
                                            </div>
                                    ...
                                    <div>
                                        <a href="{{ route ('stu.register') }}"  class="user-signup-link">
                ...
                <div class="col-md-12"​ style="padding-top:10px; width: auto;">
                    <a href="#" class="easy-link-menu">
                        <div class="dash-card card-blue text-xs-center">
                            <div class="card-block">
                                ...
                                <p class="card-text">
                                បើអ្នកជាសិស្សសូមប្រើប្រាសគណនីរបស់អ្នកដើម្បីចូលប្រលងសាកល្បង។
                                <br> បើសិនអ្នកជាភ្លៀវសូមប្រើគណនីនេះ៖​
                                    UserName: Guest
                                    <br>
                                    Pawword:Guest
                                </p>
