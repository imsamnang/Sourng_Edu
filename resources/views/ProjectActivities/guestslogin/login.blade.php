                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="space-6"></div>
                                    <form method="POST" action="{{ url('/loginbook/LoginReadBook') }}">
                                        {{ csrf_field() }}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                {{-- <a href="{{ route('student-course') }}"><button type="button" class="width-35 pull-right btn btn-sm btn-primary">
                                                    <i class="ace-icon fa fa-key"></i>
                                                    <span class="bigger-110">Login</span>
                                                </button>
                                                </a> --}}
...
{{--     <div class="col-md-2" style="padding-top:20px;">
        ...
        <a href="#" class="easy-link-menu">
            <div class="dash-card card-sky text-xs-center">
                <div class="card-block">
                    ...
                    <p class="card-text">សូមធ្វើការ Log In ដើម្បីចូលអានសៀវភៅ</p>
                    <p class="card-text">E-mail: guestlog@gmail.com</p> 
                    <p class="card-text">Password: gust123</p>
 ...
 {{--    <div class="col-md-2" style="padding-top:20px;">
        <a href="{{ route('read-book') }}" class="easy-link-menu">
    ...
    {{-- <div class="col-md-6" style="padding-top:20px; margin-left: 25%;">
        <a href="http://schoolmis.edu/exam/pre-test" class="easy-link-menu">
    ...
    <!-- <div class="col-md-2"​ style="padding-top:20px;">
        <a href="http://schoolmis.edu/" class="easy-link-menu">
