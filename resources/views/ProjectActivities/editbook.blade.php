        ...
        <div class="row" style="margin-top: 15px; margin-right: 15px; margin-left: 15px;">
            ...
            <div class="col-md-3">
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open(['route' => ['edit-book.update',$editbook->id],'.store', 'method' => 'POST', 'class' => 'form-horizontal',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::text('member', $editbook->member_type, ["placeholder" => "", "class" => "form-control border-form input-mask-registration","required"]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::text('title', $editbook->title, ["placeholder" => "", "class" => "form-control border-form","required"]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="hidden" name="old_adf" value="{{ $editbook->file }}">
         ...
         {{--        <div class="form-group">
                    {!! Form::label('old_file', __('staff_frm_doc_Old_File'), ['class' => 'col-sm-4 control-label']) !!}
                    <div class="col-sm-8">
                        @if ($editbook->file)
                        <a href="{{ asset($folder_name.DIRECTORY_SEPARATOR.'.'.DIRECTORY_SEPARATOR.ViewHelper::getStudentById( $editbook->id ).DIRECTORY_SEPARATOR.$editbook->file) }}" target="_blank">
                            <i class="ace-icon fa fa-download bigger-120"></i> &nbsp;{{ $editbook->file }}
                        </a>
                    </div>
                </div> --}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::textarea('description', $editbook->description, ["placeholder" => "", "class" => "form-control border-form", "rows"=>"6"]) !!}
                ...
                <div class="col-md-12 align-right">
                    <a href="{{ route('student-course') }}" class="btn btn-info btn-xs" style="border-radius: 0px;">BACK</a>
