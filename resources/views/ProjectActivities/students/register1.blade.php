...
<div class="main-content">
    ...
    <form method="POST" action="{{route('SaveRegister2')}}" accept-charset="UTF-8" class="form-horizontal" id="validation-form" enctype="multipart/form-data">
        {{csrf_field()}}
<div class="tabbable">
    ...
    <div id="registrationinfo" class="tab-pane active">
        ...
        <div class="col-sm-2">
            <input data-date-format="yyyy-mm-dd" class="form-control date-picker border-form input-mask-date" required="" name="reg_date" type="text" id="reg_date" placeholder="yyyy-mm-dd">
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
    <input data-date-format="yyyy-mm-dd" class="form-control border-form date-picker input-mask-date" required="" name="date_of_birth" type="text" id="date_of_birth" placeholder="yyyy-mm-dd">
    </div>
...
<div class="form-group">
    ...
    <label for="mobile_1" class="col-sm-1 control-label">{{ __('st-register.Phone') }}(1)</label>
    <div class="col-sm-3">
    <input class="form-control border-form input-mask-mobile"  name="mobile_1" type="text" id="mobile_1">
    </div>

    <label for="mobile_2" class="col-sm-1 control-label">{{ __('st-register.Phone') }}(2)</label>
    <div class="col-sm-3">
