        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="page-header">
                    <h1>
                        @lang('stu_frm_detail_Student')
                        <small>
                            <i class="ace-icon fa fa-angle-double-right"></i>
                            @lang('stu_frm_detail_Registration_Detail')
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                            ...
                            <div class="tabbable  ">
                                    ...
                                    <div class="tab-content no-border padding-24">
                                        <div id="profile" class="tab-pane in active">
                                           @include($data['view_path'].'.detail.includes.profile')
                                        </div><!-- /#home -->

                                        <div id="academicInfo" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.academicInfo')
                                        </div><!-- /#AcademicInfo -->

                                        <div id="fees" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.fees')
                                        </div><!-- /#home -->

                                        <div id="library" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.library')
                                        </div><!-- /#Library -->

                                        <div id="attendance" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.attendance')
                                        </div><!-- /#attendence -->

                                        <div id="examscore" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.examscore')
                                        </div><!-- /#examscore -->

                                        <div id="hostel" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.hostel')
                                        </div><!-- /#Hostel -->

                                        <div id="transport" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.transport')
                                        </div><!-- /#Transport -->

                                        <div id="documents" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.documents')
                                        </div><!-- /#Documents -->

                                        <div id="notes" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.notes')
                                        </div><!-- /#Notes -->
                                        @ability('super-admin', 'user-add')
                                        <div id="login-access" class="tab-pane">
                                            @include($data['view_path'].'.detail.includes.login-access')
                                        </div><!-- /#Login Detail -->
                                        @endability
