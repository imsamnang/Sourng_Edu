                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('download.S.N.') }}</th>
                            <th>{{ $panel }} <i class="ace-icon fa fa-download bigger-120"></i> &nbsp;</th>
                            <th>{{ __('download.Semester/Public') }}</th>
                            <th>{{ __('download.Status') }}</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a href="{{ asset('downloads'.DIRECTORY_SEPARATOR.$download->file) }}" target="_blank" class="btn btn-primary btn-minier btn-primary">
                                                <i class="ace-icon fa fa-eye bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.edit', ['id' => $download->id]) }}" class="btn btn-primary btn-minier btn-success">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $download->id]) }}" class="btn btn-primary btn-minier btn-danger bootbox-confirm" >
