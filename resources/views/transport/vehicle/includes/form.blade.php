<div class="form-group">
    {!! Form::label('number', __('Transport.Number'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('type', __('Transport.Type'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('model',  __('Transport.Model'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('description', __('Transport.Desc.'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('find_staffs', __('Transport.Find-Staff-&-Add'), ['class' => 'col-sm-12 control-label align-center']) !!}
    <div class="col-sm-12">
        ...
        <div class="align-right">
            <button type="button" class="btn btn-sm btn-primary" id="load-html-btn">
                <i class="fa fa-plus bigger-120"></i> {{ __('Transport.Add-Staff') }}
            </button>
        </div>
    </div>
</div>
