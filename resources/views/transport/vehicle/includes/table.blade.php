                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('Transport.Detail') }}</th>
                            <th>{{ __('Transport.Staffs') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>{{ __('Transport.Type') }}</td>
                                                <td>{{ $vehicle->type }}</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('Transport.Model') }}</td>
                                                <td>{{ $vehicle->model }}</td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            @if(isset($vehicle->staff))
                                                @foreach($vehicle->staff as $staff)
                                                    ...
                                                    <tr>
                                                        <td>{{ __('Transport.HomePhone') }}</td>
                                                        <td>{{ $staff->home_phone }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Transport.Mobile') }}</td>
                                                        <td>{{ $staff->mobile_1 }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Transport.Address') }}</td>
                                                        <td>{{ $staff->address }}</td>
                                                    </tr>
