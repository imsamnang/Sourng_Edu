<h4 class="header large lighter blue" id="filterBox"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;{{ __('Transport.Search') }} {{ $panel }}</h4>
<div class="form-horizontal" id="filterDiv">
    <div class="form-group">
        ...
        {!! Form::label('reg_no', __('Transport.Reg.No.'), ['class' => 'col-sm-1 control-label']) !!}
        <div class="col-sm-2">
    ...
    <div class="form-group">
        ...
        {!! Form::label('status', __('Transport.Status'), ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-4">
