        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees shift-btn btn-success" id="shift-btn" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-exchange" aria-hidden="true"></i> {{ __('Transport.ShiftNow') }} </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
