<div class="form-group">
    {!! Form::label('title', __('Transport.Route'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('rent', __('Transport.Rent'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('find_vehicles', __('Transport.Find-Vehicle-&-Add'), ['class' => 'col-sm-12 control-label align-center']) !!}
    <div class="col-sm-12">
        ...
        <div class="align-right">
            <button type="button" class="btn btn-sm btn-primary" id="load-html-btn">
                <i class="fa fa-plus bigger-120"></i> {{ __('Transport.Add-Vehicle') }}
            </button>
        </div>
    </div>
</div>
