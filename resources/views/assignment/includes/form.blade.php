...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-sm-2 control-label">{{ __('assignment.Faculty') }}</label>
            <div class="col-sm-5">
                {!! Form::select('faculty', $data['faculties'], null, ['class' => 'form-control', 'onChange' => 'loadSemesters(this);']) !!}
            </div>

            <label class="col-sm-2 control-label">{{ __('assignment.Semester') }}</label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="subjects_id" class="form-control semester_subject" >
                    <option> {{ __('assignment.SelectSubject') }} </option>
                </select>
            </div>
            ...
            {!! Form::label('end_date', __('assignment.EndDate'), ['class' => 'col-sm-1 control-label']) !!}
            <div class="col-sm-2">
    ...
    <div class="col-md-12 email">
        <div class="form-group">
            {!! Form::label('title', __('assignment.QuestionTitle'), ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {!! Form::label('description', __('assignment.Detail'), ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('attach_file', __('assignment.AttachmentFile'), ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-8">
    ...
    @if (isset($data['row']))
        ...
        <div class="form-group">
            {!! Form::label('old_file', __('assignment.OldFile'), ['class' => 'col-sm-2 control-label']) !!}
