<h4 class="header large lighter blue"><i class="fa fa-comment" aria-hidden="true"></i>&nbsp;{{ __('assignment.SubmitedAnswers') }}</h4>
<div class="clearfix hidden-print">
 <span class="easy-link-menu">
        <a class="btn-primary btn-sm bulk-action-btn" attr-action-type="Approve"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;{{ __('assignment.Approve') }}</a>
        <a class="btn-warning btn-sm bulk-action-btn" attr-action-type="Reject"><i class="fa fa-remove" aria-hidden="true"></i>&nbsp;{{ __('assignment.Reject') }}</a>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr >
                    ...
                    <th>{{ __('assignment.RegNo.') }}</th>
                    <th>{{ __('assignment.Name') }}</th>
                    <th>{{ __('assignment.Answer') }}</th>
                    <th>{{ __('assignment.Attachment') }}</th>
                            ...
                            <tr>
                                ...
                                <td>{{--{!! $answer->answer_text !!}--}}
                                    <a href="{{ route('assignment.answer.view',['id'=>$data['assignment']->id,'answer' => $answer->id]) }}" class="btn btn-primary btn-mini" >
                                        ...
                                        {{ __('assignment.ViewAnswerDetail') }}
                                    </a>
                                </td>
                                <td>
                                    @if($answer->file)
