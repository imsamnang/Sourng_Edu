...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label('type', __('info-smsemail.TYPE'), ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
                <label>{!! Form::radio('type[]', __('info-smsemail.sms') ,true, ["class" => "ace form-control border-form", "id"=>"typeSms","onclick" => "messageTypeCondition()"]) !!}<span class="lbl"> {{ __('info-smsemail.SMS') }} </span></label>
                <label>{!! Form::radio('type[]','email' ,false, ["class" => "ace form-control border-form", "id"=>"typeEmail","onclick" => "messageTypeCondition()"]) !!}<span class="lbl">{{ __('info-smsemail.E-mail') }}</span></label>
        ...
        <div class="col-md-12 sms">
            <div class="form-group">
                {!! Form::label('number', __('info-smsemail.Number'), ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-10">
        ...
        <div class="col-md-12 email">
            <div class="form-group">
                {!! Form::label('email', __('info-smsemail.Email'), ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-10">
