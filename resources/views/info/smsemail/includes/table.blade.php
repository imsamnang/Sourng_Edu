        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th>{{ __('info-smsemail.Subject') }}</th>
                    <th>{{ __('info-smsemail.Message') }}</th>
                    <th>{{ __('info-smsemail.Type') }}</th>
                    <th>{{ __('info-SendTo') }}</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                ...
                @else
                    <tr><td colspan="7">{{ __('info-notice.Nodatafound.') }}</td></tr>
                @endif
                </tbody>
            </table>
        </div>
