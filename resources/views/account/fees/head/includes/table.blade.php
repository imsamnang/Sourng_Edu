        ...
        <div>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th>@lang('acc_tbl_head_S_N')</th>
                    <th>@lang('acc_tbl_head_Fee_Head')</th>
                    <th>@lang('acc_tbl_head_Status')</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                @if (isset($data['fees_head']) && $data['fees_head']->count() > 0)
                    ...
                    @foreach($data['fees_head'] as $fees_head)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-minier dropdown-toggle {{ $fees_head->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="{{ route($base_route.'.edit', ['id' => $fees_head->id]) }}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.delete', ['id' => $fees_head->id]) }}" class="red bootbox-confirm">
