<h4 class="header large lighter blue"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;{{__('acc_frm_trans_Transaction_Filter')}}</h4>

<div class="form-group">
    {!! Form::label('tr_head', __('acc_frm_trans_Head'), ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::select('tr_head', $data['tr_heads'], null, ['class' => 'form-control', 'required']) !!}
    </div>

    {!! Form::label('tr_date_start', __('acc_frm_trans_Date'), ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
