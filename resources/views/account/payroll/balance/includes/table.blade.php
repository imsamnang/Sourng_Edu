<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ __('acc_breadcrumb_Payroll_Manager') }} List</h4>
        <div class="clearfix">
            <span class="pull-right tableTools-container"></span>
        </div>
        <div class="table-header">
            {{ __('acc_breadcrumb_Payroll_Manager') }}   Record list on table. Filter list using search box as your Wish.
        </div>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th>@lang('acc_tbl_balance_payroll_S_N')</th>
                    <th>@lang('acc_tbl_balance_payroll_Reg_Number')</th>
                    <th>@lang('acc_tbl_balance_payroll_Join_Date')</th>
                    <th>@lang('acc_tbl_balance_payroll_Name_of_Staff')</th>
                    <th>@lang('acc_tbl_balance_payroll_Total_Salary')</th>
                    <th>@lang('acc_tbl_balance_payroll_Balance')</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
