        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        ...
                        <th>@lang('acc_tbl_balance_payroll_Name_of_Student')</th>
                        <th>@lang('acc_tbl_balance_payroll_Semester')</th>
                        <th>@lang('acc_tbl_balance_payroll_Fee_Head')</th>
                        <th>@lang('acc_tbl_balance_payroll_Due_Date')</th>
                        <th>@lang('acc_tbl_balance_payroll_Fee_Amount')</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
