<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; {{__('acc_tbl_payment_Salary_Pay_List')}}</h4>
        <div class="clearfix">
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th>@lang('acc_tbl_payment_S_N')</th>
                    <th>@lang('acc_tbl_payment_Reg_Number')</th>
                    <th>@lang('acc_tbl_payment_Name')</th>
                    <th>@lang('acc_tbl_payment_Contact_Num')</th>
                    <th>@lang('acc_tbl_payment_Designation')</th>
                    <th>@lang('acc_tbl_payment_Qualification')</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
