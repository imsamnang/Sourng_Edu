        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        ...
                        <th>@lang('acc_tbl_payroll_S_N')</th>
                        <th>@lang('acc_tbl_payroll_Reg_Number')</th>
                        <th>@lang('acc_tbl_payroll_Name_of_Staff')</th>
                        <th>@lang('acc_tbl_payroll_Tag_Line')</th>
                        <th>@lang('acc_tbl_payroll_Payroll_Head')</th>
                        <th>@lang('acc_tbl_payroll_Due_Date')</th>
                        <th>@lang('acc_tbl_payroll_Amount')</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
