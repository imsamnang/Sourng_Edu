            ...
            <div class="row">
                <div class="col-xs-12 ">
                    ...
                    <div class="align-right">
                        <a class="{!! request()->is('studenthealth/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('studenthealth.register') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;{{__('stu_Bulk_Student_Registration')}}</a>
                    </div>
