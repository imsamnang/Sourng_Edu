<div class="form-group">
    {!! Form::label('reg_no', __('stu_doc_Reg_No'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('title', __('stu_doc_Title'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('document_file', __('stu_doc_Select_File'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
@if (isset($data['row']))
    ...
    <div class="form-group">
        {!! Form::label('old_file', __('stu_doc_Old File'), ['class' => 'col-sm-4 control-label']) !!}
        <div class="col-sm-8">
            @if ($data['row']->file)
...
<div class="form-group">
    {!! Form::label('description', __('stu_doc_Description'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
