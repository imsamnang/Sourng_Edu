    ...
    <div class="tab-content">
        <div id="registrationinfo" class="tab-pane active">
            ...
            <div class="form-group">
                ...
                @role('super-admin')
                {!! Form::label('institute_id', $data['Institute'], ['class' => 'col-sm-1 control-label',]) !!}       
                <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                <select name="cbo_teacher_exam" class="form-control border-form upper" required>
                        <option value="0">ជ្រើសខាងក្រោម៖ </option>
                        <option value="1">ក្រសួងការងារ មធ្យម</option>
                        <option value="2">ក្រសួងការងារ ឧត្តម</option>
                        <option value="3">ក្រសួងអប់រំ បឋម</option>
                        <option value="4">ក្រសួងអប់រំ មធ្យម</option>
                        <option value="5">ក្រសួងអប់រំ ឧត្តម</option>
                        <option value="6">គ្មាន</option>
                </select>

                @include('includes.form_fields_validation_message', ['name' => 'qualification'])
            </div>
        {!! Form::label('cbo_association', __('staff_frm_reg_Experience'), ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-2">
            {!! Form::text('association', null, ["class" => "form-control border-form upper",]) !!}
            @include('includes.form_fields_validation_message', ['name' => 'association'])
        </div>
