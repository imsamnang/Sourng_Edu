...
<div class="clearfix">
    {!! Form::label('reg_no', __('staff_frm_search_REG_NO'), ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-2">
        {!! Form::text('reg_no', null, ["placeholder" => "", "class" => "form-control border-form input-mask-registration", "autofocus"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'reg_no'])
    </div>

    {!! Form::label('designation', __('staff_frm_search_Designation'), ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
