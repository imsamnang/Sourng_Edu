  ...
  <div class="tab-content">
    <div id="registrationinfo" class="tab-pane active">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-1">
              {!! Form::text('reg_no', $data['row']['reg_no'], ["placeholder" => "", "class" => "form-control border-form input-mask-registration", "required"]) !!}
      ...
      <div class="form-group">
          ...
          <div class="col-sm-2">
              {!! Form::text('date_of_birth', $data['row']['date_of_birth'], ["data-date-format" => "yyyy-mm-dd", "placeholder" => "", "class" => "form-control date-picker border-form input-mask-date","required"]) !!}
      ...
      <div class="form-group">
          ...
          <div class="col-sm-3">
              {!! Form::text('email', $data['row']['email'], ["class" => "form-control border-form"]) !!}
      ...
      <div class="form-group">
          ...
          <div class="col-sm-2">
              {!! Form::text('home_phone', $data['row']['home_phone'], ["class" => "form-control border-form input-mask-phone", "required"]) !!}
          ...
          <div class="col-sm-2">
              {!! Form::text('mobile_1', $data['row']['mobile_1'], ["class" => "form-control border-form input-mask-mobile"]) !!}
          ...
          <div class="col-sm-2">
              {!! Form::text('mobile_2', $data['row']['mobile_2'], ["class" => "form-control border-form input-mask-mobile"]) !!}
      ...
      <div class="form-group">
        ...
        <select style="width: 100%" name="province_id" id="province">
          ...
          @foreach ($data['provinces'] as $key => $item)
            <option value="{{ $key }}"
            {{ $data['row']['province_id']== $key?'selected':'' }}
            >{{ $item }}</option>
          @endforeach
         </select>
        ...
        <div class="col-sm-3">
          <select style="width: 100%" name="district_id" id="district" required="" >
            <option value="0">{{ $data['option'] }}</option>
            @foreach ($data['districts'] as $key => $item)
              <option value="{{ $key }}"
              {{ $data['row']['district_id']== $key?'selected':'' }}
              >{{ $item }}</option>
            @endforeach
          </select>
        </div>
        ...
        <div class="col-sm-3">
          ...
          <option value="0">{{ $data['option'] }}</option>
          @foreach ($data['communes'] as $key => $item)
            <option value="{{ $key }}"
              {{ $data['row']['commune_id']== $key?'selected':'' }}
            >{{ $item }}</option>
          @endforeach
          </select>
        </div>  
