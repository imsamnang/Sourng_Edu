<div class="form-group">
    {!! Form::label('semester', __('Faculty.Sem./Sec'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('gradingType_id', __('Faculty.GradingType'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('semester', __('Faculty.CourseFindandAdd'), ['class' => 'col-sm-12 control-label align-center']) !!}
    <div class="col-sm-12">
        ...
        <div class="align-right">
            <button type="button" class="btn btn-sm btn-primary" id="load-html-btn">
                <i class="fa fa-plus bigger-120"></i> {{ __('Faculty.AddCourse') }}
            </button>
        </div>
    </div>
</div>
