<div class="form-group">
    {!! Form::label('faculty', __('Faculty.Faculty/Class'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
        {!! Form::text('faculty', null, ["placeholder" => __('Faculty.e.g.BBA/Class1'), "class" => "form-control border-form upper","required"]) !!}
...
@if(isset($data['semester']) && $data['semester']->count() > 0)
    <div class="form-group">
        <label class="col-sm-12 control-label align-left" for="status"> {{ __('Faculty.Semester/Section') }} &nbsp;&nbsp;&nbsp;</label>
