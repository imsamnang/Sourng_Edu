<div class="form-group">
    {!! Form::label('title', __('AttendanceStatus.AttendanceStatus'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('display_class', __('AttendanceStatus.DisplayColor'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
