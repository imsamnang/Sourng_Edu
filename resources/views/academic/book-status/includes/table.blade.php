                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('book-status.S.N.') }}</th>
                            <th>{{ __('book-status.BooksStatus') }}</th>
                            <th>{{ __('book-status.Status') }}</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="{{ route($base_route.'.edit', ['id' => $book_status->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $book_status->id]) }}" class="red bootbox-confirm">
                        ...
                        @else
                            <tr>
                                <td colspan="6">{{ __('book-status.Nodatafound.') }}</td>
                                </td>
                            </tr>
                        @endif
                    </tbody>
