                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('year.S.N.') }}</th>
                            <th>{{ __('year.Year') }}</th>
                            <th>{{ __('year.ActiveYear') }}</th>
                            <th>{{ __('year.Status') }}</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="{{ route($base_route.'.edit', ['id' => $year->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                                                    ...
                                                    <li>
                                                        <a href="{{ route($base_route.'.delete', ['id' => $year->id]) }}" class="tooltip-error bootbox-confirm" data-rel="tooltip" title="Delete">
                                                            <span class="red ">
                        ...
                        @else
                            <tr>
                                <td colspan="6">{{ __('year.Nodatafound.') }}</td>
                                </td>
                            </tr>
                        @endif
                    </tbody>
