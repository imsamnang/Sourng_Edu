<div class="form-horizontal ">
    <div class="clearfix">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-1 control-label">@lang('exam_frm_sched_Faculty')</label>
            <div class="col-sm-4">
                {!! Form::select('faculty', $data['faculties'], null, ['class' => 'form-control', 'onChange' => 'loadSemesters(this);']) !!}

            </div>

            <label class="col-sm-1 control-label">@lang('exam_frm_sched_Semester')</label>
            <div class="col-sm-2">
            ...
            <label class="col-sm-1 control-label">@lang('exam_frm_sched_Subject')</label>
            <div class="col-sm-3">
