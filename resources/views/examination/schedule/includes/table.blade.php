<h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{__('exam_tbl_Exam_Schedule_List')}}</h4>
<div class="clearfix">
    <span class="pull-right tableTools-container"></span>
</div>
<div class="table-header">
     Exam Schedule Record list on table. Filter list using search box as your Wish.
</div>
...
<div class="table-responsive">
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>@lang('exam_tbl_S_N')</th>
                    <th>@lang('exam_tbl_Year')</th>
                    <th>@lang('exam_tbl_Month')</th>
                    <th>@lang('exam_tbl_Exam')</th>
                    <th>@lang('exam_tbl_Faculty')</th>
                    <th>@lang('exam_tbl_Semester')</th>
                    <th>@lang('exam_tbl_Result_Status')</th>
                    <th>@lang('exam_tbl_Exam_Status')</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
