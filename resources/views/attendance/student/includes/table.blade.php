        ...
        <div class="table-responsive">
            ...
            <table width="100%" id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th>@lang('att_tbl_student_S_N')</th>
                    <th>@lang('att_tbl_student_Reg_Num')</th>
                    <th>@lang('att_tbl_student_Student_Name')</th>
                    <th>@lang('att_tbl_student_Year')</th>
                    <th>@lang('att_tbl_student_Month')</th>
                    <th>1</th>
                    <th>2</th>
                    <th>3</th>
                    <th>4</th>
                ...
                @else
                    <tr>
                        <td colspan="42">No {{ $panel }} data found.</td>
                        </td>
                    </tr>
                @endif
                </tbody>
