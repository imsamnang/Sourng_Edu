                         ...
                         {!! Form::open(['route' => $base_route.'.store', 'method' => 'POST', 'class' => 'form-horizontal',
                           ...
                           <div class="form-group">
                               <label class="pos-rel">
                                   ...
                                   <span class="lbl"></span> <span class="label label-info" >@lang('att_frm_studet_Send_Alert_When_Attendance_Save') </span>
                               </label>

                               <label class="pos-rel">
                                   {!! Form::radio('send_alert', 0, true, ['class' => 'ace', "required"]) !!}
                                   <span class="lbl"></span> <span class="label label-warning" >@lang('att_frm_studet_Alert_Not_Required')</span>
                               </label>
                           </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-12 align-right">
                                    ...
                                    <button class="btn btn-info" type="submit" id="submit-attendance">
                                        ...
                                        @lang('att_frm_student_Save_Attendance')
                                    </button>
                                </div>
                            </div>
