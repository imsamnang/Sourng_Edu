<h4 class="header large lighter blue"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;{{__('att_frm_staff_Search_Student')}}</h4>
<div class="form-horizontal">
    <div class="form-group">
        <label class="col-sm-2 control-label">@lang('att_frm_staff_Year')</label>
        <div class="col-sm-4">
            {!! Form::select('year', $data['years'], null, ['class' => 'form-control']) !!}

        </div>

        <label class="col-sm-2 control-label">@lang('att_frm_staff_Month')</label>
        <div class="col-sm-4">
            {!! Form::select('month', $data['months'], null, ['class' => 'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('reg_no', __('att_frm_staff_REG_NO'), ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-4">
