      ...
      <table class="table">
        ...
        <tbody>
          @foreach($quiz->questions as $question)
            <tr>
              <td>
              	<a href="{{ route('quiz.question.show', [$quiz->slug, $question->slug]) }}">{{ $question->title }}</a>
              </td>
              ...
              <td>
              	<a href="{{route('quiz.question.edit',$question->slug)}}">Edit Question</a> |
                <a href="{{route('quiz.question.destroy',$question->slug)}}">Delete Question</a>
              </td>
            </tr>
          @endforeach
        </tbody>
      </table>
      <a href="/quiz" class="btn btn-success">Home</a>
