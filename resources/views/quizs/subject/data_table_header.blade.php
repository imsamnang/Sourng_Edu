 <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Topic @lang('Panel_List') </h4>
<div class="clearfix">
  <span class="easy-link-menu">
    <a href="{{route('subjects.create')}}" class="btn-success btn-sm bulk-action-btn" attr-action-type="active"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;@lang('btn_st_Add')</a>
