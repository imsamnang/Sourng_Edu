...
<head>
    ...
    <!-- Styles -->
    <link href="{{ asset('assets/quiz/all.css') }}" rel="stylesheet">

    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('assets/quiz/sweetalert.css')}}">
    <link rel="stylesheet" href="{{asset('assets/quiz/flipclock.css')}}">
...
<body id="app-layout">
  ...
  <script type="text/javascript" src="{{asset('assets/quiz/flipclock.min.js')}}"></script>
  {{-- <script src="{{ elixir('js/app.js') }}"></script> --}}
  <script src="{{asset('assets/quiz/sweetalert.min.js')}}"></script>
  <script>
