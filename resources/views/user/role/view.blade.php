                ...
                <div class="col-xs-12">
                    ...
                    @if (Gate::allows('accessUserManager', auth()->user()))
                        <a href="{{ route($base_route) }}" class="btn btn-xs btn-info">
                            <i class="icon-backward bigger-120"></i>&nbsp;{{ __('user.Goback') }}
                        </a>
                        <a href="{{ route($base_route.'.add') }}" class="btn btn-xs btn-info">
                            <i class="icon-plus bigger-120"></i>&nbsp;{{ __('user.Add') }} {{ $panel }}
                        </a>
                    @endif    
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>{{ __('user.ContactNumber') }}r</td>
                                        <td>{{ $data['row']->contact_number }}</td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('user.Createat') }}</td>
                                        <td>{{ $data['row']->created_at }}</td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('user.Lastupdated') }}</td>
                                        <td>{{ $data['row']->last_updated_at }}</td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('user.Createdby') }}</td>
