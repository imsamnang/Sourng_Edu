<h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ $panel }} {{ __('hostel.table.List') }}</h4>
<div class="clearfix hidden-print">
    <span>
        ...
        <a type="button" class="btn-primary btn-sm open-AddRooms" data-toggle="modal"
            ...
            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp {{ __('hostel.AddBeds') }}
        </a>
    </span>
