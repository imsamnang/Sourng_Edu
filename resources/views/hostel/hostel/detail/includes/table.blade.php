<h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ __('hostel.table.roomlist') }}</h4>
<div class="clearfix hidden-print">
    <span>
        ...
        <a class="btn-warning btn-sm bulk-action-btn" attr-action-type="in-active"><i class="fa fa-remove" aria-hidden="true"></i>&nbsp;{{ __('m_stu_detail_in_active') }}</a>
        ...
        <a type="button" class="btn-primary btn-sm open-AddRooms" data-toggle="modal"
            ...
            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp {{ __('hostel.table.AddRooms') }}
        </a>
    </span>
    <span class="pull-right tableTools-container"></span>
</div>
<div class="table-header hidden-print">
    {{ __('hostel.table.roomlist.table') }}
</div>
<div>
        ...
        <div class="table-responsive">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr >
                    ...
                    <th>{{ __('hostel.table.roomno') }}</th>
                    <th>{{ __('hostel.button.RoomType') }}</th>
                    <th>{{ __('hostel.table.Rate/Bed') }}</th>
                    <th>{{ __('hostel.table.TotalBeds') }}</th>
                    <th>{{ __('hostel.table.Available') }}</th>
                    <th>{{ __('hostel.table.Occupied') }}</th>
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            <td colspan="11">{{ __('Faculty.Nodatafound.') }}</td>
                            </td>
                        </tr>
                    @endif
                </tbody>
