        ...
        <div class="modal-content">
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group mb0">
                            <div class="col-sm-12">
                                {!! Form::label('start', __('hostel.Start'), ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-2">
                                    {!! Form::number('start',null, ['class' => 'form-control', "required", "onkeyup"=>"changeStartCode()", "id"=>"start", "min"=>"1"]) !!}
                                </div>

                                {!! Form::label('end', __('hostel.End'), ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-2">
                                    {!! Form::number('end',null, ['class' => 'form-control', "required","onkeyup"=>"changeEndCode()", "id"=>"end", "min"=>"1" ]) !!}
                                </div>

                                {!! Form::label('total', __('hostel.Total'), ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-2">
                        ...
                        <div class="form-group ">
                            <div class="col-sm-12">
                                {!! Form::label('room_type', __('hostel.button.RoomType'), ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-6">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees save_button btn-success" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-home" aria-hidden="true"></i> {{ __('hostel.addroom') }} </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
