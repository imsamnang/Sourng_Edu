        ...
        <div class="modal-content">
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">{{ __('hostel.button.Hostel') }}</label>
                                    <div class="col-sm-9">
                                        {!! Form::select('hostel_shift', $data['hostels'], null, ['class' => 'form-control', "onChange" => "loadRooms(this)"]) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">{{ __('hostel.table.Rooms') }}</label>
                                    <div class="col-sm-3">
                                    ...
                                    <label class="col-sm-3 control-label">{{ __('hostel.form.Bed') }}</label>
                                    <div class="col-sm-3">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees shift_button btn-success" id="shift-btn" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-exchange" aria-hidden="true"></i> {{ __('hostel.table.Shift.Now') }} </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
