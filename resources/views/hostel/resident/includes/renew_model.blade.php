        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="submit" class="btn cfees save_button btn-success" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <i class="fa fa-bed" aria-hidden="true"></i> {{ __('hostel.form.assignbed') }} </button>
                </div>
            </div>
        </div>
        {!! Form::close() !!}
