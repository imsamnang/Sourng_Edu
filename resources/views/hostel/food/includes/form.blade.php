<div class="form-group">
    {!! Form::label('hostels_id', __('hostel.button.Hostel'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    ...
    {!! Form::label('days_id', __('hostel.table.Day'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('eating_times_id', __('hostel.table.time'), ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
...
<div class="form-group">
    {!! Form::label('food_items', __('hostel.form.FindFoodItem&Add'), ['class' => 'col-sm-12 control-label align-center']) !!}
    <div class="col-sm-12">
        {!! Form::select('food_items', [], null, ["placeholder" => __('hostel.TypeFoodName'), "class" => "col-xs-12 col-sm-12", "style" => "width: 100%;"]) !!}
        ...
        <div class="align-right">
            <button type="button" class="btn btn-sm btn-primary" id="load-html-btn">
                <i class="fa fa-plus bigger-120"></i> {{ __('hostel.form.AddFood') }}
            </button>
        </div>
    </div>
</div>
