...
!(function($) {
  jQuery.fn.extend({
    QRcode: function(qrcodeSuccess, qrcodeError, videoError) {
      return this.each(function() {
        ...
        navigator.getUserMedia
          ? navigator.getUserMedia({ video: !0 }, successCallback, function(
              error
            ) {
    ...
    QRcode_input:function(node,qrcodeSuccess){
      return this.each(function(){  
