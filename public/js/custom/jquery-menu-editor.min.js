function MenuEditor(l, t) {
  ...
  function d() {
    a[0].reset(),
      (c = c.iconpicker(e)).iconpicker("setIcon", "empty"),
      o.attr("disabled", !0),
      (s = null);
  }
  function p(e) {
  ...
  function f() {
    var e = $("<div>").addClass("btn-group float-right"),
      s = p({ classCss: "btn btn-primary btn-sm btnEdit", text: r.labelEdit }),
      t = p({
  ...
  i.sortableLists(r.listOptions),
        ...
        $.ajax({
          ...
          success: response => {
            ...
            $(this)
              ...
              .remove();
            var t = !1;
            void 0 !== s.attr("id") && (t = s.attr("id").toString() === l),
              s.children().length ||
                t ||
                (s
                  .prev("div")
        ...
        (function(e) {
          ...
          $.each(s, function(e, s) {
            ...
            a
              ...
              .first()
              .focus(),
            s.hasOwnProperty("icon")
              ? c.iconpicker("setIcon", s.icon)
    ...
    (this.update = function() {
      ...
      if (null !== e) {
        ...
        var dataString = $('form[id="frmEdit"]')
          .serializeArray()
        ...
        $.ajax({
          type: "POST",
          url: $('form[id="frmEdit"]').attr("action"),
          data: dataString,
          dataType: "json",
          cache: false,
          success: response => {
          ...
          if (response.success) {
            var s = f(),
              ...
              n = $("<div>")
                ...
                .append(s),
              o = $("<li>").data(e);
            o.addClass("list-group-item pr-2").append(n),
              i.append(o),
              MenuEditor.updateButtons(i),
              d();
          }
      ...
      if (null !== s) {
        ...
        var t = (function d(e, s) {
          ...
          return (
            $.each(e, function(e, s) {
              var t =
                  void 0 !== s.children && $.isArray(Object.values(s.children)),
                l = {
                  text: "",
                  href: "",
                  icon: "empty",
        ...
        n
          ...
          : (t.sortableLists(r.listOptions), (n = !0)),
          MenuEditor.updateButtons(i);
      }
    }),
    (this.save = function() {
  ...
  (L.fn.sortableLists = function(e) {
    var s = L("body").css("position", "relative"),
      ...
      p = L("<" + d.listSelector + " />")
        ...
        .css(d.baseCss)
        .addClass(d.listsClass + " " + d.baseClass),
      u = L("<li />")
        .attr("id", "sortableListsPlaceholder")
        .css(d.placeholderCss)
        .addClass(d.placeholderClass),
      f = L("<li />")
        .attr("id", "sortableListsHint")
        .css(d.hintCss)
        .addClass(d.hintClass),
      r = L("<" + d.listSelector + " />")
        .attr("id", "sortableListsHintWrapper")
        .addClass(d.listsClass + " " + d.hintWrapperClass)
        .css(d.listsCss)
        .css(d.hintWrapperCss),
      a = L("<span />")
        .addClass("sortableListsOpener " + d.opener.openerClass)
        .css(d.opener.openerCss)
        .on("mousedown touchstart", function(e) {
    ...
    "class" == d.opener.as
      ...
      : (a.css("background-image", "url(" + d.opener.close + ")"),
        console.error(
    ...
    if (d.opener.active) {
      ...
      L(this)
        ...
        .each(function() {
          var e = L(this);
          e.children(d.listSelector).length &&
            (a.clone(!0).prependTo(e.children("div").first()),
            e.hasClass("sortableListsOpen") ? C(e) : l(e));
        });
    }
    return this.on("mousedown touchstart", function(e) {
      var s = L(e.target);
      if (
        !(!1 !== h.isDragged || (d.ignoreClass && s.hasClass(d.ignoreClass)))
      ) {
        ...
        t[0] &&
          ...
          (function(e, s, t) {
            ...
            (h.rootEl = {
              ...
              (h.cEl = { el: s, mT: l, mL: o, mB: n, mR: i, offset: r }),
              (h.cEl.xyOffsetDiff = {
                X: e.pageX - h.cEl.offset.left,
                Y: e.pageY - h.cEl.offset.top
              }),
              h.cEl.el.addClass("sortableListsCurrent " + d.currElClass),
              s.before(u);
            ...
            s
              ...
              .prependTo(p),
              c.css({ display: "block", height: a }),
              f.css("height", a),
              h.doc
                .on("mousemove touchmove", v)
                .on("mouseup touchend touchcancel", b);
          })(e, t, l));
      }
    });
    function v(e) {
      if (h.isDragged) {
        var s = h.cEl,
          t = h.doc,
          l = h.win;
        "touchmove" === e.type && m(e),
          e.pageX ||
            (((i = e).pageY = h.pY),
            (i.pageX = h.pX),
            (i.clientY = h.cY),
            (i.clientX = h.cX)),
          t.scrollTop() > h.rootEl.offset.top - 10 && e.clientY < 50
            ? h.upScroll
              ? ((e.pageY = e.pageY - d.scroll),
                L("html, body").each(function(e) {
            ...
            : t.scrollTop() + l.height() <
                h.rootEl.offset.top + h.rootEl.el.outerHeight(!1) + 10 &&
              l.height() - e.clientY < 50
            ? h.downScroll
              ? ((e.pageY = e.pageY + d.scroll),
                L("html, body").each(function(e) {
                  L(this).scrollTop(L(this).scrollTop() + d.scroll);
          ...
          (h.oEl = oEl = (function(e, s) {
                ...
                (t =
                  null ==
                    (n = document.elementFromPoint(
                      0,
                      l + L(window).height() - 1
                    )) || "HTML" == n.tagName.toUpperCase()),
                0 < (l = h.doc.scrollLeft()) &&
                  (t =
                    null ==
                      (n = document.elementFromPoint(
                        l + L(window).width() - 1,
            ...
            var o = L(document.elementFromPoint(e, s));
            {
              ...
              if (
                o.is("#sortableListsPlaceholder") ||
                o.is("#sortableListsHint")
              )
                return null;
          ...
          (function(e, s) {
            ...
            d.insertZonePlus
              ? n < 14
                ? (function(e, s, t) {
                    L("#sortableListsHintWrapper", h.rootEl.el).length &&
                      f.unwrap();
                    if (!t && e.pageX - s.offset().left > d.insertZone) {
                      ...
                      if (
                        n
                          .children()
                          .first()
                          .is("#sortableListsPlaceholder")
                      )
                        return f.css("display", "none");
                      n.length ? n.prepend(f) : (l.first().after(f), f.wrap(r)),
                        h.oEl && C(s);
                    } else {
                  ...
                  (function(e, s, t) {
                    ...
                    if (!t && e.pageX - s.offset().left > d.insertZone) {
                      ...
                      if (
                        ...
                        return f.css("display", "none");
                      n.length ? l.last().append(f) : (s.append(f), f.wrap(r)),
                        h.oEl && C(s);
                    } else {
              ...
              ? (function(e, s) {
                  ...
                  if (e.pageX - s.offset().left < d.insertZone) {
                    ...
                    if (
                      ...
                      return f.css("display", "none");
                    l.length ? l.prepend(f) : (t.first().after(f), f.wrap(r)),
                      h.oEl && C(s);
                  }
                  f.css("display", "block"),
                    (h.isAllowed = d.isAllowed(
                ...
                (function(e, s) {
                  ...
                  if (e.pageX - s.offset().left < d.insertZone) {
                    ...
                    if (
                      ...
                      return f.css("display", "none");
                    l.length ? t.last().append(f) : (s.append(f), f.wrap(r)),
                      h.oEl && C(s);
                  }
                  f.css("display", "block"),
                    (h.isAllowed = d.isAllowed(
    ...
    function b(e) {
      ...
      ("touchend" !== e.type && "touchcancel" !== e.type) || m(e),
        "block" == n.display && l.length && h.isAllowed
          ? ((o = l), (i = !0))
          : ((o = h.placeholderNode), (i = !1)),
        (offset = o.offset()),
        t.el.animate(
          { left: offset.left - h.cEl.mL, top: offset.top - h.cEl.mT },
          250,
          function() {
            var e, s;
            (s = (e = t).el[0].style),
              e.el.removeClass(d.currElClass + " sortableListsCurrent"),
              (s.top = "0"),
              (s.left = "0"),
              (s.position = "relative"),
              (s.width = "auto"),
              ...
              (n.display = "none"),
              l.remove(),
              r.removeAttr("id").removeClass(d.hintWrapperClass),
              r.length && r.prev("div").prepend(a.clone(!0)),
              i
                ? h.placeholderNode.slideUp(150, function() {
                    h.placeholderNode.remove(),
                      E(),
                      d.onChange(t.el),
                      d.complete(t.el),
                      (h.isDragged = !1);
        ...
        g(h),
        h.doc
          .unbind("mousemove touchmove", v)
          .unbind("mouseup touchend touchcancel", b);
    }
    function c(e) {
      (h.pY = e.pageY),
        (h.pX = e.pageX),
    ...
    function C(e) {
      e.removeClass("sortableListsClosed").addClass("sortableListsOpen"),
        e.children(d.listSelector).css("display", "block");
      var s = e
        .children("div")
        .children(".sortableListsOpener")
        .first();
      "html" == d.opener.as
        ? s.html(d.opener.close)
        : "class" == d.opener.as
        ? s.addClass(d.opener.close).removeClass(d.opener.open)
        : s.css("background-image", "url(" + d.opener.close + ")");
    }
    function l(e) {
      e.removeClass("sortableListsOpen").addClass("sortableListsClosed"),
        e.children(d.listSelector).css("display", "none");
      var s = e
        .children("div")
        .children(".sortableListsOpener")
        .first();
      "html" == d.opener.as
        ? s.html(d.opener.open)
        : "class" == d.opener.as
        ? s.addClass(d.opener.open).removeClass(d.opener.close)
        : s.css("background-image", "url(" + d.opener.open + ")");
    }
    function E() {
    ...
    (L.fn.iconOpen = function(e) {
      ...
      var s = this.children("div")
        ...
        .first();
      "html" === e.opener.as
        ? s.html(e.opener.close)
        : "class" === e.opener.as &&
          s.addClass(e.opener.close).removeClass(e.opener.open);
    }),
    (L.fn.iconClose = function(e) {
      ...
      var s = this.children("div")
        ...
        .first();
      "html" === e.opener.as
        ? s.html(e.opener.open)
        : "class" === e.opener.as &&
          s.addClass(e.opener.open).removeClass(e.opener.close);
    }),
